...
function CloseIcon(props) {
    return (
        <IconBase {...props} variant='fillOnly' size={45}>
            <g id='SVGRepo_bgCarrier' strokeWidth='1.2'/>
            ...
            <g id='SVGRepo_iconCarrier'> 
                ...
                <path>
                    fillRule='evenodd' 
                    clipRule='evenodd' 
                    d='M23 4C23 2.34315 21.6569 1 20 1H4C2.34315 1 1 2.34315 1 4V20C1 21.6569 2.34315 23 4 23H20C21.6569 23 23 21.6569 23 20V4ZM21 4C21 3.44772 20.5523 3 20 3H4C3.44772 3 3 3.44772 3 4V20C3 20.5523 3.44772 21 4 21H20C20.5523 21 21 20.5523 21 20V4Z' fill='#0F0F0F'
                </path> 
            </g>
        </IconBase>
    );
